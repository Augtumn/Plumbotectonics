...
| 数据 | 最大绝对偏差 | 平均 | RMSE |
|---|---|---|---|
| 论文表 3（99 个生长曲线值） | 0.6211 | 0.2199 | 0.2719 |
| 论文表 4（6 个现今值） | 0.4715 | 0.1793 | 0.2353 |

> **表 3 没有复现**（该表印到 0.01，只有 12/99 落在 ±0.005 内）。从两张表分别
...
1. **基准校验** — Version IV 复现 Haines & Zartman (1988) Table 4 全部 24 个
   ...
   12 项元素丰度（1 % 以内）；中国模型复现论文表 4（最差 0.4715）——表 3
