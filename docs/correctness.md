...
|---|---|---|---|---|---|
| 论文表 4（现今 `238U/204Pb`、`Th/U`） | 6 | 0.4715 | 0.1793 | 0.2353 | `abs < 0.65` / `abs < 0.10`（`Th/U`） |
| 论文表 3（生长曲线） | 99 | 0.6211 | 0.2199 | 0.2719 | **未复现**，仅以回归上限 0.62 / 0.15 钉住 |
...
- 中国模型对每个旋回新增 3 层：上地壳侧 2 层（新成上地壳层，以及 10 % 残余
  造山带形成的沉积岩层）、下地壳侧 1 层（新成下地壳层），11 个旋回共 33 层；
